...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.sellyouravatar.wiki'
  const path = '/terms-of-service'

  return {
    title: "Terms of Service - Sell Your Avatar Wiki",
    description: "Read the Terms of Service for Sell Your Avatar Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: "Sell Your Avatar Wiki",
      title: "Terms of Service - Sell Your Avatar Wiki",
      description: "Terms and conditions for using Sell Your Avatar Wiki.",
      images: [
        {
          url: `${siteUrl}/og-image.jpg`,
          width: 1200,
          height: 630,
          alt: "Sell Your Avatar Wiki",
        },
      ],
    },
    twitter: {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Sell Your Avatar Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Sell Your Avatar Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Sell Your Avatar Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Sell Your Avatar Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Sell Your Avatar". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and booth strategies</li>
              <li>Codes and Coins earning guides</li>
              <li>Outfit creation and customization tips</li>
              <li>Trading and marketplace information</li>
              <li>Avatar item unlock walkthroughs</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Sell Your Avatar Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official developers of Sell Your Avatar. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Sell Your Avatar Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of Sell Your Avatar. We use such
            ...
            <ul>
              ...
              <li><strong>Game Updates:</strong> Roblox game content, codes, items, and events may change without notice. We are not responsible for in-game changes or access.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, SELL YOUR AVATAR WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Sell Your Avatar Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@sellyouravatar.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@sellyouravatar.wiki</a>
            </p>
            <p>
