...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Sell Your Avatar Wiki',
    description: 'Copyright and intellectual property information for Sell Your Avatar Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Sell Your Avatar Wiki',
      description: 'Copyright and intellectual property information for Sell Your Avatar Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Sell Your Avatar Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Sell Your Avatar Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Sell Your Avatar Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Sell Your Avatar Developers</strong> - Creators of the Sell Your Avatar game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Sell Your Avatar</strong> - Trademark of the game developers</li>
              <li><strong>Sell Your Avatar Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Sell Your Avatar Wiki.
            </p>
            ...
            <p>
              ...
              Sell Your Avatar Wiki<br />
              Email: <a href="mailto:dmca@sellyouravatar.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@sellyouravatar.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Sell Your Avatar Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Sell Your Avatar Wiki (sellyouravatar.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@sellyouravatar.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@sellyouravatar.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@sellyouravatar.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@sellyouravatar.wiki</a>
            </p>
            <p>
